...
FIXED_BBOX = [550, 12, 860, 416]  # ←←← 按你的画面分辨率填
...
def load_params():
    ...
    # ==================== 尺寸规格配置 ====================
    prof = rospy.get_param("~size_profile", "toilet")  # 尺寸规格类型: "sink"(洗手盆) 或 "toilet"(马桶)
    p["size_profile"] = prof
    if prof == "toilet":
        # 马桶尺寸规格范围(米)
